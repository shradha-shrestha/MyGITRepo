...
(function ($) {
    ...
    var options = {
        ...
        progressWidget = function () {
            return '<div class="progress" style="margin-left:170px; margin-top:10px; width:220px;"><div class="bar"></div></div>';
        },
        ...
        methods = {
            ...
            outputErrorList: function () {
                this.each(function (idx, el) {
                    var output = '<ul class="error-list" style="margin-left:200px;">',
                        $el = $(el),
